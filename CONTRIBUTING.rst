...
2. Clone your fork locally::
    ...
    $ git clone git@github.com:your_name_here/aoba_discord_bot.git

3. Install your local copy into a virtualenv. Assuming you have virtualenvwrapper installed, this is how you set up your fork for local development::

    $ mkvirtualenv aoba_discord_bot
    $ cd aoba_discord_bot/
...
3. The pull request should work for Python 3.8, 3.9 and 3.10. Check
   https://travis-ci.com/douglascdev/aoba_discord_bot/pull_requests
